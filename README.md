...
The baseline runs `go test ./...`, verifies Go formatting, checks module-qualified imports, and ensures the behavior tests for key derivation, proxy-aware IP lookup, IPv6 RemoteAddr parsing, header-value matching, and 429 responses remain in place.
